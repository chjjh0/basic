...
public static void main(String[] args) {
	...
	while(true) {
		...
		Object option = JOptionPane.showInputDialog(null, "MENU1", "MENU2", JOptionPane.QUESTION_MESSAGE, null, menu, "");
		//String option = JOptionPane.showInputDialog("메뉴를 골라주세요");
		//JOptionPane.showMessageDialog(null, option +"을 선택함");
		/*s.showInputDialog(
				"0:종료 \n" 
				+ "%s [%s원]\n"
				+ "%s [%s원]\n"
